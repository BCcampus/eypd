...
/**
 * Takes an array of long/lat values, finds the average
 * returns a single long/lat array coordinate as the center
 *
 * @param $et_var_lat
 * @param $et_var_lng
 *
...
/**
 * Given a post ID, returns relevant post information
 *
 * @param $post_id
 *
 * @return array|bool
...
/**
 * returns an html blob, holds/displays information related to the marker
 *
 * @param int $post_id
 * @param array $data
 * @param int $index
