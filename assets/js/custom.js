(function ($) {
    ...
    $.fn.et_simple_slider = function (options) {
        var settings = $.extend({
            ...
            slideshow: false,						    // automatic animation?
            slideshow_speed: 7000,					    // automatic animation speed
            on_slide_changing: function () {
            },					// callback function that runs when a slide changes
            on_slide_change_end: function () {
            }					// callback function that runs when a slide changes
        }, options);
