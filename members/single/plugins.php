...
<div id="content" role="main" class="<?php ( ! is_page() && ! $pagename === 'events' ) ? do_action( 'content_class' ) : do_action( 'no_sidebar_content_classes' ); ?>">
	<div class="padder">
		...
		<div id="item-body" role="main">
			...
			<h1><?php do_action( 'bp_template_title' ); ?></h1>
