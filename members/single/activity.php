...
<?php
	//Limit the user profile to just their name and address when not themselves
	else :
?>
<?php do_action( 'bp_before_profile_loop_content' ); ?>

<?php //Just show the user name when not logged in. No other xprofile fields are available ?>
