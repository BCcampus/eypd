                ...
                {has_location}<br/><i>#_LOCATIONNAME, #_LOCATIONTOWN #_LOCATIONSTATE</i>{/has_location}" ); ?></td>
                        ...
                        <td>
                            <input id="eypd-cert-hours-<?php echo $event_id; ?>"
                                   ...
                                   value="1"
                                   type='radio' <?php if( !isset($user_hours[ $event_id ]) ) $user_hours[ $event_id ] = '' ;  echo ( $user_hours[ $event_id ] || ! isset( $user_hours[ $event_id ] ) ) ? 'checked="checked"' : ''; ?> />
                        </td>
                        <td>
                            <input id="eypd-cert-hours-<?php echo $event_id; ?>"
                                   name=eypd_cert_hours[<?php echo $event_id; ?>]
                                   value="0"
                                   type='radio' <?php if( !isset($user_hours[ $event_id ]) ) $user_hours[ $event_id ] = '' ;  echo ( ! $user_hours[ $event_id ] ) ? 'checked="checked"' : ''; ?> />
					<?php
					$count ++;
				}
				?>
