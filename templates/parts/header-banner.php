	...
	<header id="header" role="banner">
		<div id="logo-menu-wrap">
			...
			<a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bcid-logo.svg" width="101" height="92" alt="BC Provincial Government">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/eypd-logo-mark.svg" width="135" height="92" alt="Early Years Professional Development">
			</a>
