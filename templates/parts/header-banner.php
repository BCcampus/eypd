	...
	<header id="header" role="banner">
		<div id="logo-menu-wrap">
			...
			<a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/bcid-logo-101x92.png" width="101" height="92" alt="BC Provincial Government">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/eypd-logomark-135x92.png" width="135" height="92" alt="Early Years Professional Development">
			</a>
