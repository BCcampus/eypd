...
jQuery(document).ready(function ($) {
    ...
    if ($("#em-tickets-form").length > 0) {
        ...
        //Ticket(s) UI
        var reset_ticket_forms = function reset_ticket_forms() {
    ...
    if ($('#em-bookings-table').length > 0) {
        ...
        if ($("#em-bookings-table-settings").length > 0) {
            ...
            $(document).delegate('#em-bookings-table-settings-trigger', 'click', function (e) {
                e.preventDefault();$("#em-bookings-table-settings").dialog('open');
            });
            //Export Overlay
            $("#em-bookings-table-export").dialog(em_bookings_export_dialog);
            $(document).delegate('#em-bookings-table-export-trigger', 'click', function (e) {
                e.preventDefault();$("#em-bookings-table-export").dialog('open');
            });
            var export_overlay_show_tickets = function export_overlay_show_tickets() {
...
var em_ajaxify = function em_ajaxify(url) {
...
function em_maps_load() {
    if (!em_maps_loaded) {
        if (jQuery('script#google-maps').length == 0 && ((typeof google === 'undefined' ? 'undefined' : _typeof(google)) !== 'object' || _typeof(google.maps) !== 'object')) {
            ...
            document.body.appendChild(script);
        } else if ((typeof google === 'undefined' ? 'undefined' : _typeof(google)) === 'object' && _typeof(google.maps) === 'object' && !em_maps_loaded) {
            em_maps();
...
function em_maps() {
    ...
    if (jQuery('select#location-select-id, input#location-address').length > 0) {
        var map, marker;
        //load map info
        var refresh_map_location = function refresh_map_location() {
            ...
            if (!(location_latitude == 0 && location_longitude == 0)) {
                ...
                map.panBy(40, -55);
                infoWindow.setContent('<div id="location-balloon-content"><strong>' + mapTitle + '</strong><br/>' + jQuery('#location-address').val() + '<br/>' + jQuery('#location-town').val() + '</div>');
        ...
        var get_map_by_id = function get_map_by_id(id) {
        ...
        jQuery('#location-name, #location-town, #location-address, #location-state, #location-postcode, #location-country').change(function () {
            ...
            if (address == '') {
                //in case only name is entered, no address
                jQuery('#em-map').hide();
                jQuery('#em-map-404').show();
                return false;
            }
...
(function (e) {
    ...
    function i(e, t) {
        return (typeof e === 'undefined' ? 'undefined' : _typeof(e)) == "object" ? o(e) : s(e, t);
    }
    ...
    e._timePicker = function (r, u) {
        ...
        var b = function b() {
            ...
            var t = e(r).offset();
            m.css({ top: t.top + r.offsetHeight, left: t.left });
            m.show();
...
/***/ "./assets/styles/editor-tabs.scss":
/***/ (function(module, exports) {
...
__webpack_require__("./assets/js/events-manager.js");
__webpack_require__("./assets/styles/style.scss");
__webpack_require__("./assets/styles/editor.scss");
__webpack_require__("./assets/styles/editor-tabs.scss");
__webpack_require__("./assets/styles/admin.scss");
__webpack_require__("./assets/styles/events.scss");
module.exports = __webpack_require__("./assets/styles/tinymce.scss");
